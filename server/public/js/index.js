...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	         ...
	         */
	        value: function initTypeList() {
	            // type_list 是一个 Map 数据结构
	            this.type_list.set('r2', {
	                name: '任二',
	                bouns: 6,
	        ...
	        value: function setOpenCode(code) {
	            ...
	            try {
	                for (var _iterator2 = open_code.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        ...
	        value: function changePlayNav(e) {
	            ...
	            // 更新 DOM
	            (0, _jquery2.default)('#zx_sm span').html(self.type_list.get(self.cur_play).tip);
	            // 切换玩法后要把上次选中的号码重置
	        ...
	        value: function addCode() {
	            ...
	            var count = self.calcCount(active, self.cur_play);
	        ...
	        value: function getCount() {
	            ...
	            var count = self.calcCount(active, self.cur_play);
	            // 计算奖金范围
	            var range = self.calcBonus(active, self.cur_play);
	            var money = count * 2;
	        ...
	        value: function getRandomCode(e) {
	            ...
	            // 获取玩法，如：3
	            var type = this.cur_play.match(/\d+/g)[1];
	            var self = this;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lottery = __webpack_require__(6);

	var _lottery2 = _interopRequireDefault(_lottery);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var syy = new _lottery2.default(); // 入口文件
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calc = __webpack_require__(4);
	...
	var Lottery = function (_mix) {
	    ...
	    return Lottery;
	}(mix(_base2.default, _interface2.default, _calc2.default, _time2.default));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Interface = function () {
	    ...
	    _createClass(Interface, [{
	        ...
	        key: 'getOpenNumber',
	        value: function getOpenNumber(issue) {
	            var self = this;
	            return new Promise(function (resolve, reject) {
	                _jquery2.default.ajax({
	                    url: '/get/openNumber',
